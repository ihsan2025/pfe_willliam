...
<body style="padding-top: 50px;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="process_appointment.php" method="POST">
                        ...
                        <label for="doctor_id">Doctor:&nbsp;&nbsp;</label><span id="doctor_id" class="font-weight-bold"></span>
                        <label for="status" class="d-block">Select Status:</label>
    ...
    <script>
        ...
        function editAppointment(data) {
            ...
            document.getElementById('doctor_id').innerHTML = data.doctor_name || '';
